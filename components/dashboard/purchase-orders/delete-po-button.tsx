...
export function DeletePOButton({ poId, poNumber, onDeleted }: { poId: string; poNumber: string; onDeleted?: (id: string) => void }) {
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">Delete Purchase Order</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  Are you sure you want to delete PO <span className="font-semibold text-slate-700 dark:text-slate-300">{poNumber}</span>? This action cannot be undone.
                </p>
